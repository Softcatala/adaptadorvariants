...
s/\bNextCloud\([^[:alnum:]]\)/Nextcloud\1/g
...
s/\bA~fegeix\([^[:alnum:]]\)/A\~fig\1/g
s/_aquest\([^[:alnum:]]\)/_este\1/g
s/\bde~sa\([^[:alnum:]]\)/gua~rda\1/g
s/\bDe~sa\([^[:alnum:]]\)/Gua~rda\1/g
s/\bEn~darrere\([^[:alnum:]]\)/A\~rrere\1/g
s/\be~ndavant\([^[:alnum:]]\)/ava\~nt\1/g
s/\bEn~rere\([^[:alnum:]]\)/A\~rrere\1/g
s/\ben~rere\([^[:alnum:]]\)/a\~rrere\1/g
s/\bVerme~ll\([^[:alnum:]]\)/~Roig\1/g
 #
s/_Desa\([^[:alnum:]]\)/Guar_da\1/g
s/_desa\([^[:alnum:]]\)/guar_da\1/g
s/\bDe_sa\([^[:alnum:]]\)/_Guarda\1/g
s/\bde_sa\([^[:alnum:]]\)/_guarda\1/g
 #
...
s/\b\([Cc]\)inquè\([^[:alnum:]]\)/\1inqué\2/g
s/\b\([Ss]\)isè\([^[:alnum:]]\)/\1isé\2/g
s/\b\([Ss]\)etè\([^[:alnum:]]\)/\1eté\2/g
s/\bVuitè\([^[:alnum:]]\)/Huité\1/g
s/\bvuitè\([^[:alnum:]]\)/huité\1/g
s/\b\([Nn]\)ovè\([^[:alnum:]]\)/\1ové\2/g
s/\b\([Dd]\)esè\([^[:alnum:]]\)/\1esé\2/g
s/\b\([Oo]\)nzè\([^[:alnum:]]\)/\1nzé\2/g
s/\b\([Dd]\)otzè\([^[:alnum:]]\)/\1otzé\2/g
s/\b\([Tt]\)retzè\([^[:alnum:]]\)/\1retzé\2/g
s/\b\([Cc]\)atorzè\([^[:alnum:]]\)/\1atorzé\2/g
s/\b\([Qq]\)uinzè\([^[:alnum:]]\)/\1uinzé\2/g
s/\b\([Ss]\)etzè\([^[:alnum:]]\)/\1etzé\2/g
s/\b\([Dd]\)issetè\([^[:alnum:]]\)/\1isseté\2/g
s/\b\([Dd]\)ivuitè\([^[:alnum:]]\)/\1ihuité\2/g
s/\b\([Dd]\)inovè\([^[:alnum:]]\)/\1inové\2/g
s/\b\([Vv]\)intè\([^[:alnum:]]\)/\1inté\2/g
s/\b\([Tt]\)rentè\([^[:alnum:]]\)/\1renté\2/g
s/\b\([Qq]\)uarantè\([^[:alnum:]]\)/\1uaranté\2/g
s/\b\([Cc]\)inquantè\([^[:alnum:]]\)/\1inquanté\2/g
s/\b\([Ss]\)eixantè\([^[:alnum:]]\)/\1eixanté\2/g
s/\b\([Ss]\)etantè\([^[:alnum:]]\)/\1etanté\2/g
s/\bVuitantè\([^[:alnum:]]\)/Huitanté\1/g
s/\bvuitantè\([^[:alnum:]]\)/huitanté\1/g
s/\b\([Nn]\)orantè\([^[:alnum:]]\)/\1oranté\2/g
s/\b\([Cc]\)entè\([^[:alnum:]]\)/\1enté\2/g
s/\b\([Mm]\)ilè\([^[:alnum:]]\)/\1ilé\2/g
s/\b\([Mm]\)ilionè\([^[:alnum:]]\)/\1ilioné\2/g
...
s/\b\(amb S-Pen\|beta\|carregar un àudio\|creació d'imatges\|disponible\|durant l'inici\|[Ee]ditar un camp de text\|encara no és funcional\|[Ee]smena\|[Ee]smenes\|[Ee]smena l'error\|[Ee]smenat l'error\|[Ee]smena un error\|[Ee]smenat un error\|[Ee]smena una fallada\|[Ee]smenat una fallada\|[Ee]smena un problema\|[Ee]smenat un problema\|esmenat diversos errors\|esmenat el desament de fotogrames d'enregistrament com a JPEG\|evitar problemes\|[Ee]xecutant-se\|exportació d'animacions\|fallada freqüent\|fallades més freqüents\|feina\|filmació a intervals de l'enregistrador\|funciona\|integrat\|KDE Connect\|Krita\|mostrar-les\|mostrin les nanses de selecció\|per a la tauleta\|QAccesibility»\|Qt[123456789]\) a Android\([^[:alnum:]]\)/\1 en Android\2/g
# a Angle
...
s/\b\(AppStream\|[Cc]erqueu-ne més\|disponible\|disponibles\|Fcitx5\|[Mm]ostr[ei]n\|[Tt]robeu-ne més\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Discover\([^[:alnum:]]\)/\1 en \2Discover\3/g
# a Distrobox
...
# a eines
s/\b\(rebutjada\|rebutjades\|rebutjat\|rebutjats\) a eines\([^[:alnum:]]\)/\1 en eines\2/g
# a Ekos
...
# a EkosLive
s/\bA EkosLive\([^[:alnum:]]\)/En EkosLive\1/g
s/\b\([Ee]ntrena\) a EkosLive\([^[:alnum:]]\)/\1 en EkosLive\2/g
# a Enfocament
...
# a ESP
s/\b\(està GRUB\) a ESP\([^[:alnum:]]\)/\1 en ESP\2/g
# a espais
...
# a Fedora
s/\b\(grub.cfg<\/code>\) a Fedora\([^[:alnum:]]\)/\1 en Fedora\2/g
# a finals
...
# a General
s/\b\(fitxer de còpia de seguretat\|que tenim\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)General\([^[:alnum:]]\)/\1 en \2General\3/g
# a Gentoo
...
# a Haiku
s/\b\(Haiku»\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Haiku\([^[:alnum:]]\)/\1 \2en \3Haiku\4/g
# a haver
s/\b\(obtenir ajuda i no\) a haver\([^[:alnum:]]\)/\1 en haver\2/g
# a HDR
s/\b\(millores\) a HDR\([^[:alnum:]]\)/\1 en HDR\2/g
# a HFR
...
s/\b\([Dd]esenvolupar\|[Dd]esenvolupar programari de KDE\|disponible\|disponibles\|El desenvolupament del nucli\|fer coses\|fer tota mena de coses\|funcion[ei]n\|lliure, i\|mostr[ei]n\|proporcionen eines i documentació\|realitzar diverses tasques\|sigui de KDE\|Skrooge\|tenim\|utilitzar màquines virtuals\) a KDE\([^[:alnum:]]\)/\1 en KDE\2/g
...
# a «KisTimeBasedItemModel» | «KisMergeLabeledLayersCommand» | «KisMplTest» | «KisPerspectiveTransformWorker» | os-autoinst-distri-kdelinux
s/\b\(desfà de la divisió per zero\|esmenat un avis de model\|esmenat un problema\|esmenat una fallada\|generar una imatge de referència\|inicia la canonada\|rectangles\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\(KisTimeBasedItemModel\|KisMergeLabeledLayersCommand\|KisMplTest\|KisPerspectiveTransformWorker\|os-autoinst-distri-kdelinux\)\([^[:alnum:]]\)/\1 en \2\3\4/g
# a KMail
...
s/\b\([Ee]xecuta\|mostrant una interfície de línia d'ordres\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Konsole\([^[:alnum:]]\)/\1 en \2Konsole\3/g
# a Kontact
...
# a LabPlot
s/\bA LabPlot\([^[:alnum:]]\)/En LabPlot\1/g
# a Libera
...
s/\() i\|amb les Qt6\|astrometry.net»\|basada\|basat\|configurar una impressora\|digiKam\|disponible\|disponible per als usuaris d'Ekos\|especialment\|esteu\|executen sense problemes\|faran la mateixa feina\|funcionava\|ignora\|Instal·lació de controladors de NVIDIA\|[Ii]nstal·lar\|[Ii]nstal·lats per l'usuari\|jugar els meus jocs\|Krita [123456789],\|KStars\|Per a accedir-hi\|per primera vegada\|s'ignora\|Wayland\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Linux\([^[:alnum:]]\)/\1 en \2Linux\3/g
...
s/\b\(així com el menú d'aplicacions\|digiKam\|disponible\|[Ee]smena\|[Ee]smenes\|[Ee]smena l'error\|[Ee]smenat l'error\|[Ee]smena un error\|[Ee]smenat un error\|[Ee]smena una fallada\|[Ee]smenat una fallada\|[Ee]smena un problema\|[Ee]smenat un problema\|esmenes d'errors\|G'MIC\|importar àudio\|importava àudio\|macOS\|nova\|ora»\|però també\|provada\|Qt[123456789]\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)macOS\([^[:alnum:]]\)/\1 \2en \3macOS\4/g
# a main
s/\b\(flux rellevant\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)main\([^[:alnum:]]\)/\1 en \2main\3/g
# a Marble
...
# a Mastodon
s/\b\(any\|Final de la 10»\|KDE Eco\|publicació\) a Mastodon\([^[:alnum:]]\)/\1 en Mastodon\2/g
# a Matrix
...
# a obtenir
s/\b\(en realitzar proves unitàries d'eficiència energètica o\) a obtenir\([^[:alnum:]]\)/\1 en obtenir\2/g
# a oferir
s/\b\(centrat\) a oferir\([^[:alnum:]]\)/\1 en oferir\2/g
# a Okular
s/\bA Okular\([^[:alnum:]]\)/En Okular\1/g
s/\b\(admesos\|errada\|manuals\) a Okular\([^[:alnum:]]\)/\1 en Okular\2/g
# a Opcions
...
# a OSCAR
s/\bA \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)OSCAR\([^[:alnum:]]\)/En \1OSCAR\2/g
s/\b\(especificat\|Messdaten\*)\|[Uu]tilitzada\|[Uu]tilitzades\|[Uu]tilitzat\|[Uu]tilitzats\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)OSCAR\([^[:alnum:]]\)/\1 en \2OSCAR\3/g
# a pantalla
...
# a PyKrita
s/\b\(canvi d'eina i de pinzells\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)PyKrita\([^[:alnum:]]\)/\1 en \2PyKrita\3/g
# a Python
...
# a Stable
s/\b\(Obteniu les últimes esmenes d'error\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Stable\([^[:alnum:]]\)/\1 en \2Stable\3/g
# a Steam
...
# a storage
s/\b\(sysupdate»\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)storage\([^[:alnum:]]\)/\1 en \2storage\3/g
# a SVG
...
# a systemd
s/\b\(apareixerà com una entrada sense versió\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)systemd\([^[:alnum:]]\)/\1 en \2systemd\3/g
# a systemsettings
s/\bA &systemsettings\([^[:alnum:]]\)/En \&systemsettings\1/g
...
# a terra
s/\b\(cavar forats\|peus\) a terra\([^[:alnum:]]\)/\1 en terra\2/g
# a text
...
s/\b\(administració d'empreses\|[Ee]nganxa\|feia «Enganxa en una imatge nova»\|obert\|oberts\|sobre múltiples elements\) a una\([^[:alnum:]]\)/\1 en una\2/g
# a UNIX
...
s/\b\(amb la compressió «Deflate»\|ANGLE\|ANSVR\|AppData»\|[Cc]lang [123456789][0123456789]\|[Cc]orregeix una icona\|digiKam\|disponible\|[Ee]smena\|[Ee]smenes\|[Ee]smena l'error\|[Ee]smenat l'error\|[Ee]smena un error\|[Ee]smenat un error\|[Ee]smena una fallada\|[Ee]smenat una fallada\|[Ee]smena un problema\|[Ee]smenat un problema\|[Ee]smena una regressió\|[Ee]smenat una regressió\|[Ee]smenes d'errors\|establert el renderitzador gràfic a «direct3d11»\|estarà disponible en alguns ordinadors,\|esteu\|faries servir\|feies\|funciona\|i -\?\|implementació per a la cadena d'eines llvm-mingw\|[Ii]nstal·lació\|instal·lar\|JPEG-XL\|Krita\|Krita [123456789]\|macOS, i possiblement\|millor que\|neochat) i\|només\|presència de «bt2020PQColorSpace»\|Python\|Qt[123456789]\|requereix\|[Uu]tilitz[aio]\|[Uu]tilitzable\|[Uu]tilitzada\|[Uu]tilitzades\|[Uu]tilitzant\|[Uu]tilitza[rt]\|[Uu]tilitzar-l[ao]\|[Uu]tilitzar-l[eo]s\|[Uu]tilitzar-se\|[Uu]tilitzarà\|[Uu]tilitzaran\|[Uu]tilitzats\|[Uu]tilitzaven\|[Uu]tilitze[nsu]\|utilitzen «Deflate»\|windows11\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Windows\([^[:alnum:]]\)/\1 \2en \3Windows\4/g
...
s/\b\([Cc]om\|esmenat una fallada a un apuntador d'esdeveniment nul\) a l'acció\([^[:alnum:]]\)/\1 en l'acció\2/g
 #
...
s/\bA l'altre \(costat\|extrem\|sistema\)\([^[:alnum:]]\)/En l'altre \1\2/g
s/\b\(agrupi\|canviat a «Alguna CoSA»\|correspon a un fitxer amb el mateix nom\|estàs\|executarà de forma sincrònica\|expandit per espais\|Feu això\|Fusió a tres bandes amb base»\|i la imatge final\|la Terra,\|suprimit\|té una imatge\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a l'altr\([ae]\)\([^[:alnum:]]\)/\1 \2en l'altr\3\4/g
 #
...
# a l'amfitrió
s/\b\([Ee]xecuta\|[Ee]xecutant-se\|[Ee]xecutar la prova\|[Ee]xecuteu «indiserver»\) a l'amfitrió\([^[:alnum:]]\)/\1 en l'amfitrió\2/g
# a l'amplada
...
# a l'annex
s/\b\(Blue Angel\|trobar\) a l'\(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\([Aa]\)nnex\([^[:alnum:]]\)/\1 en l'\2\3nnex\4/g
# a l'anterior
...
# a l'apèndix
s/\b\(defineix\|trobar\) a l'\(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\([Aa]\)pèndix\([^[:alnum:]]\)/\1 en l'\2\3pèndix\4/g
# a l'API
s/\bA l'API\([^[:alnum:]]\)/En l'API\1/g
...
# a l'Assessor
s/\b\(Ajust aproximat»\|les funcions posteriors\|preconfiguració de la rosca\) a l'\(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Assessor\([^[:alnum:]]\)/\1 en l'\2Assessor\3/g
# a l'assistent
...
# a l'avantguarda
s/\b\(estan\|estem\|posar el programari lliure i KDE\|posar KDE i el programari lliure\|posat el programari lliure\) a l'avantguarda\([^[:alnum:]]\)/\1 en l'avantguarda\2/g
# a l'avís
...
# a l'ecosistema
s/\b\(Business_models_for_open-source_software)\) a l'ecosistema\([^[:alnum:]]\)/\1 en l'ecosistema\2/g
# a l'edifici
...
s/\(\\"\|com\|executi\|funciona\|[Mm]illora\|millorar dràsticament la fidelitat del color\|[Mm]illores\|partida\|[Pp]artida nova\|[Uu]tilitz[aio]\|[Uu]tilitzable\|[Uu]tilitzada\|[Uu]tilitzades\|[Uu]tilitzant\|[Uu]tilitza[rt]\|[Uu]tilitzar-l[ao]\|[Uu]tilitzar-l[eo]s\|[Uu]tilitzar-se\|[Uu]tilitzarà\|[Uu]tilitzaran\|[Uu]tilitzats\|[Uu]tilitzaven\|[Uu]tilitze[nsu]\|útils\) a l'entorn\([^[:alnum:]]\)/\1 en l'entorn\2/g
...
# a l'informe
s/\b\(cap operació\|disponible\|estaven\|Inclou o no els ingressos\|Inclou o no les despeses\|Inclou o no les operacions agrupades\|Inclou o no les operacions seguides\|Inclou o no les transferències\|Mostra la versió\|tenen en compte\|ús no desitjat de dades»\) a l'informe\([^[:alnum:]]\)/\1 en l'informe\2/g
 #
...
s/\b\(es produeixen a casa o\) a l'oficina\([^[:alnum:]]\)/\1 en l'oficina\2/g
 #
s/\b\(col·laboradors centrals de KDE\) a les oficines\([^[:alnum:]]\)/\1 en les oficines\2/g
# a l'ombra
 #
...
# a l'ordre
s/\b\(emprat\|error\|errònia\|[Ee]rror de sintaxi\|indicat\|Paràmetre incorrecte\|problemes de xarxa i regressions\|proporcionada\|subministrat\|Un <placeholder>&#37;s<\/placeholder>\|[Uu]tilitz[aio]\|[Uu]tilitzable\|[Uu]tilitzada\|[Uu]tilitzades\|[Uu]tilitzant\|[Uu]tilitza[rt]\|[Uu]tilitzar-l[ao]\|[Uu]tilitzar-l[eo]s\|[Uu]tilitzar-se\|[Uu]tilitzarà\|[Uu]tilitzaran\|[Uu]tilitzats\|[Uu]tilitzaven\|[Uu]tilitze[nsu]\|utilitzar les variables <b>%1, %2… %9<\/b>\|utilitza[rt]\) a l'ordre\([^[:alnum:]]\)/\1 en l'ordre\2/g
 #
...
s/\b\(cerqueu «client RDP»\|comprar alguns articles\|disponible\|disponible aviat\|estan\|He dit que\|ingressés\|Krita\|repositori de F-Droid i\|tenir en compte que \*\*no\*\*\) a la botiga\([^[:alnum:]]\)/\1 en la botiga\2/g
 #
s/\b\(Krita\|programari, per exemple\) a les botigues\([^[:alnum:]]\)/\1 en les botigues\2/g
# a la branca
...
# a la canonada
s/\b\([Mm]illora\|[Mm]illores\) a la canonada\([^[:alnum:]]\)/\1 en la canonada\2/g
# a la cantonada
...
s/\b\(4656x3520\|com es ressalta\|defineix tot seguit\|Error\|exclou les decoracions\|exclou les ombres\|feu\|inclou el punter\|més recentment emprat\|[Mm]ostra\|mostra't\|Per exemple,\|s'inclou\|s'inclouen\|tal com s'il·lustra\) a la captura\([^[:alnum:]]\)/\1 en la captura\2/g
 #
...
# a la comunitat
s/\bA la comunitat\([^[:alnum:]]\)/En la comunitat\1/g
s/\b\(com\|Contingut recent\|tant\|trobar\|trobar-se\) a la comunitat\([^[:alnum:]]\)/\1 en la comunitat\2/g
 #
s/\bA les comunitats\([^[:alnum:]]\)/En les comunitats\1/g
...
s/\b\(Brisa»\|[Cc]anvis notables\|[Dd]esenvolupament\|disponibles\|disponibles per a la prova\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a les \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\([Cc]\)onstruccions\([^[:alnum:]]\)/\1 \2en les \3\4onstruccions\5/g
# a la consulta
...
# a la documentació
s/\b\(es descriu com «més lògic»\|falten\|incloure\|obtenir la mida del pas\|troben\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a la documentació\([^[:alnum:]]\)/\1 \2en la documentació\3/g
# a la drecera
 #
...
s/\b\(il·lustra\|il·lustrat\|mostra\|ubicació de les zones comunes\|veu\) a la \([Ff]\)igura\([^[:alnum:]]\)/\1 en la \2igura\3/g
# a la fila
...
# a la fotografia
s/\b\(causar una certa pèrdua de qualitat\|compleixen el mateix paper que els negatius de pel·lícula\|determinar el balanç de blancs correcte\|disminuir els detalls de les ombres\|es veu sovint\|icones de gir\|imprimeix\|incrustada\|incrustades\|incrustat\|incrustats\|inundacions\|l'esquerra,\|troba les vores de color\|ubicació dels motius principals\) a la fotografia\([^[:alnum:]]\)/\1 en la fotografia\2/g
 #
...
# a la guia
s/\b\(descriu\|Proveïdor de cerques\) a la \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)guia\([^[:alnum:]]\)/\1 en la \2guia\3/g
# a la GPU
...
s/\b\(desenvolupament del nucli\|[Dd]esenvolupar\|[Dd]esenvolupar programari KDE\|disponible\|disponibles\|executeu el següent\|existent\|explorar les seves creacions\|fer coses\|fer diverses tasques\|fer tota mena de coses\|[Ff]eu això\|funciona\|funcionen\|funcionen bé\|[Hh]i ha només un requisit específic\|instal·lar\|pot ser enganyosa;\|preinstal·lat\|proves d'openQA\|publicar la pestanya personalitzada\|realitzar diverses tasques\|recomanada\|sigui de KDE\|solucionar aquesta incidència\|Substituït amb &DBus;\|treballar\|utilitzar màquines virtuals\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a la \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\(&kde\|KDE\)\([^[:alnum:]]\)/\1 \2en la \3\4\5/g
# a la «KoPathTool
...
s/\b\(poden estar presents\) a la lletra\([^[:alnum:]]\)/\1 en la lletra\2/g
 #
s/\b\(predeterminada\) a les lletres\([^[:alnum:]]\)/\1 en les lletres\2/g
# a la llibreta
...
# a les Nominacions
s/\b\(es va votar\) a les \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\([Nn]\)ominacions\([^[:alnum:]]\)/\1 en les \2\3\4ominacions\5/g
# a la nostra
s/\b\(col·laboració\|conversa\|dir hola\|emprar\|esforç\|fer-les\|Inclourem el vostre esdeveniment\|llistats\|produeixen\|vosaltres mateixos\) a la \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)nostra\([^[:alnum:]]\)/\1 en la \2nostra\3/g
 #
s/\b\([Ff]omentem una cultura de sostenibilitat digital\) a les nostres\([^[:alnum:]]\)/\1 en les nostres\2/g
# a la nota
...
# a la pila
s/\b\(dades temporals\|encara funcionen es llancen\|ordre\|ordres\) a la pila\([^[:alnum:]]\)/\1 en la pila\2/g
# a la pista
...
# a la presentació
s/\b\(David Hurka\|[Dd]ibuix\|negra\) a la presentació\([^[:alnum:]]\)/\1 en la presentació\2/g
# a la primera
...
# a la regió
s/\b\(2Fnyb)\|[Mm]ostra\|públic local\|troba\) a la regió\([^[:alnum:]]\)/\1 en la regió\2/g
# a la regla
...
# a la revista
s/\b\(future\.2018\.02\.044)\) a la revista\([^[:alnum:]]\)/\1 en la revista\2/g
# a la roda
s/\b\(El 8é sòcol\|trobat el filtre %1\) a la roda\([^[:alnum:]]\)/\1 en la roda\2/g
# a la rodalia
...
# a la seva
s/\b\(Aprofundiu en la història de KDE\|calcular les coordenades dels píxels de tots els objectes\|disponibles\|Linux Cafe\|necessita\|mostrar el llenç\|[Pp]atrocina crèdits gratuïts\|posa la documentació per a cada mòdul\|reparatur-cafe-he.de\/)\|s'indica\|trobaràs\) a la seva\([^[:alnum:]]\)/\1 en la seva\2/g
...
# a la vida
s/\b\(amb textura\|descobrir la bellesa\|utilitzat\|utilitzats\) a la vida\([^[:alnum:]]\)/\1 en la vida\2/g
...
# a la vostra
s/\b\(ajudar en la traducció de la documentació de &kde;\|allotjat\|aniversaris dels contactes\|[Cc]erca\|cerca de \*similitud\*\|col·laboradors que visquin\|com a «%1»\|configurat\|[Cc]onstruïu la petició de fusió\|desi\|disponible\|distribuir-l[ao]\|eines d'empaquetat noves\|entrada nova\|equip FOSS potent\|es troba\|esdevingut un canvi\|establert\|establerta\|festes d'instal·lació\|forma segura\|grup de treball\|grup motivat\|hi ha grups d'usuaris de Linux o cafès de Linux\|identificar una plantilla\|incloure\|instal·lar\|llista\|[Oo]bteniu el programari KDE\|organitzar una instal·lació\|paquet\|problema\|processarà localment\|ràpides\|s'instal·la\|trobar un lloc o esdeveniment\|trobareu el nom de l'amfitrió\|trobat\|utilitzeu Btrfs\) a la vostra\([^[:alnum:]]\)/\1 en la vostra\2/g
...
s/\b\(Aranya\|baixi qualsevol fitxer\|[Aa]nuncia el servei\|[Cc]erca\|[Cc]erca dispositius\|compartir elements\|comparteixin\|digitalitzar-les amb una rèflex digital\|kde-<projectname\\\\>\|kde-devel)\|des d'un ordinador remot\|disponibles\|Monopoly®\|[Pp]arla amb amics\|problema\|reconeixement de les cares\|repositoris\|són nodes propis\|transparents\|transport\|únics\|[Uu]tilitz[aio]\|[Uu]tilitzable\|[Uu]tilitzada\|[Uu]tilitzades\|[Uu]tilitzant\|[Uu]tilitza[rt]\|[Uu]tilitzar-l[ao]\|[Uu]tilitzar-l[eo]s\|[Uu]tilitzar-se\|[Uu]tilitzarà\|[Uu]tilitzaran\|[Uu]tilitzats\|[Uu]tilitzaven\|[Uu]tilitze[nsu]\|Usuaris actuals\) a la \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)xarxa\([^[:alnum:]]\)/\1 en la \2xarxa\3/g
 #
s/\b\(activa\|difusió\|impulsarem el projecte\|Kiki\|Llista de 10»\|presència de Krita\|publica l'esdeveniment\|publicacions\|publiqueu sobre l'esdeveniment\) a les \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)xarxes\([^[:alnum:]]\)/\1 en les \2xarxes\3/g
# a la xerrada
s/\bA la xerrada\([^[:alnum:]]\)/En la xerrada\1/g
# a la zona
...
# al guiatge
s/\b\([Nn]ombroses esmenes\) al guiatge\([^[:alnum:]]\)/\1 en el guiatge\2/g
# al calaix
...
# al fotograma
s/\b\([Aa]ctiva la detecció de píxels cremats\|[Aa]ctiva la detecció de píxels freds\|centre de les estrelles\|detectades\|detectar\|detectava\|Mostra HFR de les estrelles\|reduir el soroll\) al fotograma\([^[:alnum:]]\)/\1 en el fotograma\2/g
 #
...
# al núvol
s/\b\(conflicte amb una adreça d'interès\|creiem que l'emmagatzematge\|emmagatzemar les vostres dades\|executat\|L'emmagatzematge\|llavors\|mitjançant l'entrenament\|Shells\) al núvol\([^[:alnum:]]\)/\1 en el núvol\2/g
# al paquet
...
s/\b\(ajustar els paràmetres\|amb el mode «Esborrador»\|cap dispositiu compatible\|seleccionar els paràmetres d'inici del port sèrie i de comunicació de la xarxa dels dispositius\|seleccionat\) al perfil\([^[:alnum:]]\)/\1 en el perfil\2/g
 #
s/\b\(escriure\) als perfils\([^[:alnum:]]\)/\1 en els perfils\2/g
# al pinzell
...
# al port
s/\b\(amfitrió INDI a %1\|amfitrió PHD2: %1,\|els vaixells\|escoltant\|iniciat els serveis INDI\|Mòdem\|servidor INDI %1\) al port\([^[:alnum:]]\)/\1 en el port\2/g
# al porta-retalls
...
# al programador
s/\(»\|la canonada CI\/CD i\|[Mm]illora\|[Mm]illores\|Planificador del mosaic``\) al \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)\([Pp]\)rogramador\([^[:alnum:]]\)/\1 en el \2\3rogramador\4/g
# al programari
...
# al punter
s/\b\(esmenat la fallada\) al punter\([^[:alnum:]]\)/\1 en el punter\2/g
# al quadrat
...
# al registre
s/\b\(Nivell de detall\|s'escriuran\|Vegeu els detalls\) al registre\([^[:alnum:]]\)/\1 en el registre\2/g
# al repositori
...
# al tren
s/\b\(Barlow\|caps de setmana, i\|hi ha una placa d'ajust de la inclinació\|[Gg]ir de la càmera\|límit de resolució)\|s'inclou un filtre\) al tren\([^[:alnum:]]\)/\1 en el tren\2/g
# als vaixells
...
# a una aplicació
s/\b\([Dd]esa el fitxer d'índex de l'astrometria\|desar un fitxer d'índex de l'astrometria\|estigui\) a una aplicació\([^[:alnum:]]\)/\1 en una aplicació\2/g
# a una capa
s/\b\(creava\) a una capa\([^[:alnum:]]\)/\1 en una capa\2/g
# a una carpeta
s/\b\(estigui\) a una carpeta\([^[:alnum:]]\)/\1 en una carpeta\2/g
# a una de les vistes
...
# a una memòria
s/\b\(Graveu el sistema operatiu\) a una memòria\([^[:alnum:]]\)/\1 en una memòria\2/g
# a una paraula
...
s/\ba la \(Corunya\|Normandia\|República Txeca\|UE\|Unió Europea\|Xina\)\([^[:alnum:]]\)/en la \1\2/g
s/\ba Trysil, Noruega\([^[:alnum:]]\)/en Trysil, Noruega\1/g
  s/\ba Trysill\([^[:alnum:]]\)/en Trysil\1/g
s/\bA \(Alemanya\|Amèrica\|Anglaterra\|Arnsberg\|Augsburg\|Barcelona\|Bengaluru\|Berlin\|Brasil\|Coupvray\|Deventer\|Dublín\|Europa\|França\|Gran Canària\|Graz\|Hannover\|Harvard\|Hilpoltstein\|Holanda\|Kerala\|Letònia\|Lituània\|Ludwigsburg\|Màlaga\|Montenegro\|Munic\|Negril\|Porto Alegre\|Randa\|San Diego\|San Francisco\|São Paulo\|Salvador\|Sèrbia\|València\|Vancouver\|West Potomac Park\|Williams Bay\)\([^[:alnum:]]\)/En \1\2/g
s/\ba \(Alemanya\|Amèrica\|Anglaterra\|Arnsberg\|Augsburg\|Barcelona\|Bengaluru\|Berlin\|Brasil\|Coupvray\|Deventer\|Dublín\|Europa\|França\|Gran Canària\|Graz\|Hannover\|Harvard\|Hilpoltstein\|Holanda\|Kerala\|Letònia\|Lituània\|Ludwigsburg\|Màlaga\|Montenegro\|Munic\|Negril\|Porto Alegre\|Randa\|San Diego\|San Francisco\|São Paulo\|Salvador\|Sèrbia\|València\|Vancouver\|West Potomac Park\|Williams Bay\)\([^[:alnum:]]\)/en \1\2/g
