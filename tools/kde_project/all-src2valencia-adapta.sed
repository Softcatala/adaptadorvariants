...
s/\b\(amb S-Pen\|beta\|carregar un àudio\|creació d'imatges\|disponible\|durant l'inici\|[Ee]ditar un camp de text\|encara no és funcional\|[Ee]smena\|[Ee]smenes\|[Ee]smena l'error\|[Ee]smenat l'error\|[Ee]smena un error\|[Ee]smenat un error\|[Ee]smena una fallada\|[Ee]smenat una fallada\|[Ee]smena un problema\|[Ee]smenat un problema\|esmenat diversos errors\|esmenat el desament de fotogrames d'enregistrament com a JPEG\|evitar problemes\|[Ee]xecutant-se\|fallada freqüent\|fallades més freqüents\|feina\|filmació a intervals de l'enregistrador\|funciona\|KDE Connect\|Krita\|mostrar-les\|mostrin les nanses de selecció\|per a la tauleta\|QAccesibility»\|Qt[123456789]\) a Android\([^[:alnum:]]\)/\1 en Android\2/g
# a Angle
