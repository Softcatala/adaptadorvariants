...
s/\b\([Cc]erqueu-ne més\|disponible\|disponibles\|Fcitx5\|[Mm]ostr[ei]n\|[Tt]robeu-ne més\) a \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)Discover\([^[:alnum:]]\)/\1 en \2Discover\3/g
# a Distrobox
...
s/\b\(agrupi\|canviat a «Alguna CoSA»\|correspon a un fitxer amb el mateix nom\|estàs\|executarà de forma sincrònica\|expandit per espais\|Feu això\|Fusió a tres bandes amb base»\|i la imatge final\|suprimit\|té una imatge\) \(<[^<]\{1,\}>\|«\|\*\*\|\*\|\[\|(\[\«\|(\[\|(\|«?\$\|:doc:`\|:menuselection:`\|:ref:`\|``\|`\|\)a l'altr\([ae]\)\([^[:alnum:]]\)/\1 \2en l'altr\3\4/g
 #
