...
#
s/\b\([Dd]\)e l'\(|\|\[\|\*\|\*\*\|\*\*\*\|&\|«\|<[^<]\{1,\}>\|\)\(mplayer\|Scilab\|Scratchpad\|SDDM\|sflphone-client-kde\|Skrooge\|Skype\|SMART\|Smoothie\|Spacebar\|sqcipher\|SQLite\|Stage\|Stellarium\|Step\|Stockfish\|Stopmotion\|SVN\)\([^[:alnum:]]\)/\1e \2\3\4/g
s/\b\([Dd]\)e l'\(|\|\[\|\*\|\*\*\|\*\*\*\|&\|«\|<[^<]\{1,\}>\|\)\(Ad[Bb]lock\|Academy\|AccountWizard\|ACDSee\|Acrobat\|Actiona\|Active\|Adium\|Agrovoc\|Akkoma\|Akonadi\|akonadictl\|Akregator\|Alligator\|Almanac\|alphagrad\|Amarok\|amarokcollectionscanner\|Amazon\|Amor\|Ampache\|Analitza\|Analyze\|Anbox\|Android\|Angelfish\|Apache\|AppData\|Apper\|AppImage\|Apple\|Apport\|[Aa]ppstream\|AqBanking\|Arch\|Arduino\|Arianna\|ARJ\|Ark\|Arkade\|ART\|Associated\|Audioscrobbler\|Configuració del sistema\|Artikulate\|ask\|Astra\|Astrometry.net\|AtCore\|Atelier\|Atlantik\|Audex\|AUR\|Aura\|AV1\|AVPlayer\|AWS\|EEPROM\|EFFECT\|Ekiga\|Ekos\|EkosLive\|ELF\|Elisa\|Eloquens\|Emacs\|eMovix\|Enfuse\|EnigMail\|ESLint\|etesyncItem\|Evolution\|Evolution[123]\|EWS\|Excel\|Exchange\|[Ee]xif[Tt]ool\|extragear\|GPG\|Haruna\|Heroic\|Hessiana\|High\|HOTP\|ICC\|Icedove\|ICQ\|IFrame\|Ikona\|ImageMagick\|Image\|Image[Ss]hack\|Imgur\|ImportWizard\|INDI\|INDIHub\|Info-zip\|initramfs\|Inkscape\|inotify\|InputMethod\|inputVectorData\|inputVectorTime\|InSight\|Internet\|Invidious\|iPad\|iPod\|iPhone\|iptables\|IRIDIUM\|Itinerary\|iTip\|iTunes\|OAG\|OAuth2\|OBS\|OCR\|OCRA\|OCRAD\|Octave\|Office\|Ogg\|Okteta\|[Oo]kular\|OMEMO\|Onedrive\|Open\|OpenBabel\|OpenCL\|OpenColorIO\|OpenConnect\|OpenDivX\|OpenDocument\|OpenGL\|OpenGLES\|OpenOffice\|OpenPGP\|Opensearch\|OpenStreetMap\|OpenTimelineIO\|OpenVPN\|Opera\|Operational\|OProfile\|Opus\|Orca\|Origin\|OriginLab\|OSCAR\|OscarSocket\|OSD\|OSX\|OTR\|Outlook\|outputVectorPeriodogram\|ownCloud\|oxdvi\|Oxygen\|R\|r2\|SDDM\|Skanlite\|SkySafari\|Scilab\|Scratchpad\|Scribus\|ScriptEngine\|SDDM\|Skanpage\|sketchbook\|Skrooge\|Skype\|Slack\|SlackBridge\|Slimbook\|Smoothie\|Snap\|Spacebar\|Spectacle\|Spectral\|SPHINX\|Sphinx\|Spirit\|SQL\|Stargate\|Station\|Steam\|StellarMate\|Step\|StepCore\|U-Boot\|UberWriter\|Ubuntu\|UFRaw\|Unarchiver\|Unicode\|UnifiedPush\|UNIX\|Unrar\|updatedb\|UserFeedback\|xBase\|XDebug\|XFig\|XMMS\|XMPP\|Xplanet\|XPlanet\|XWayland\)\([^[:alnum:]]\)/\1'\2\3\4/g
...
# a l'àlbum
    ...
    s/\bmoure el lateral des del fitxer %1 a l'àlbum\([^[:alnum:]]\)/moure el lateral des del fitxer %1 cap a l'àlbum\1/g
...
s/\bA l'altre extrem\([^[:alnum:]]\)/En l'altre extrem\1/g
	s/\barrossegar a l'altra banda\([^[:alnum:]]\)/arrossegar fins a l'altra banda\1/g
...
s/\b\(característica «Adjunta el meu certificat»\|característica «Adjunta la meva clau pública»\|carregar aquesta imatge\|clicant\|com a separador\|comportar la tecla de retorn\|configuració actual\|configurats\|corregir automàticament tot el text\|De tornada\|desactiva els números de línia\|desar\|desfet\|disposició\|emplaçament\|emprat\|errors\|escrites\|escriviu-lo\|està\|Executa el fitxer obert\|i línies noves\|inserció\|inserir caràcters especials\|inserir-lo\|mostra\|mostrar la línia respectiva\|mostrarà automàticament\|mostrats\|mou\|Obre\|Obre aquesta col·lecció de vocabulari\|Obre el fitxer\|Obre els documents de vocabulari\|Obre els fitxers RAW\|Obre l'object\|Obre la carpeta\|obrir\|obrir les imatges RAW\|obrir un fitxer\|ortogràfica\|renderització d'imatges fosques\|seleccionat\|text de la finestra\|troba\|troba el camp\|ubicació de les tecles addicionals de compleció automàtica\|Utilitza la vista de color gestionat\|utilitzada\|utilitzat\|Veure\|[Zz]oom\) a l'editor\([^[:alnum:]]\)/\1 en l'editor\2/g
 #
...
# a l'executable
	s/\b\(apunti directament\|<Camí>\) a l'executable\([^[:alnum:]]\)/\1 cap a l'executable\2/g
...
# a l'extensió
	s/\benllaç a l'extensió\([^[:alnum:]]\)/enllaç cap a l'extensió\1/g
s/\b\([Ee]rror\) a l'extensió\([^[:alnum:]]\)/\1 en l'extensió\2/g
# a l'extracte
s/\b\(contingut\) a l'extracte\([^[:alnum:]]\)/\1 en l'extracte\2/g
# a l'extrem
	s/\bArrossegant a l'extrem\([^[:alnum:]]\)/Arrossegant cap a l'extrem\1/g
...
s/\b\(disponible\|Inclou o no els ingressos\|Inclou o no les despeses\|Inclou o no les operacions agrupades\|Inclou o no les operacions seguides\|Inclou o no les transferències\|Mostra la versió\|tenen en compte\) a l'informe\([^[:alnum:]]\)/\1 en l'informe\2/g
 #
s/\b\(en un valor\|inclòs\|mostrat\) als \(<[^<]\{1,\}>\|\)informes\([^[:alnum:]]\)/\1 en els \2informes\3/g
# a l'insegur
...
# a l'objectiu
	s/\bOrienta a l'objectiu\([^[:alnum:]]\)/Orienta cap a l'objectiu\1/g
...
s/\b\(activació\|activar-ho\|Ajusteu el termini de lliurament\|canviar qualsevol preferència\|desactiveu l'opció del rotor\|es pot ajustar\|especificat\|establert\|habilitada\|HFR<\/guilabel>\|mostrades\|presenten\|tasca<\/guilabel>\|Utilitza els desplaçaments de l'alba i la posta\) a les \(<[^<]\{1,\}>\|\)\([Oo]\)pcions\([^[:alnum:]]\)/\1 en les \2\3pcions\4/g
# a l'operant
...
s/\b\(comprimida\|Desa aquest perfil individual a un fitxer separat\|desades\|desar la imatge\|desaran localment\|desen\|detectar aquestes eines\|eliminant\|emmagatzemades\|executant\|executant-se\|executar\|fitxers d'índex de l'astrometria\|gestiona la impressió\|instal·lada\|instal·lades\|instal·lar KDE Connect\|instal·lat\|instal·lat correctament\|instal·lats\|invoca un programa &FTP;\|localitzar el programa <em>dvips<\/em>\|Mostra les notificacions del dispositiu\|obtenir una vista prèvia del flux\|que ho feu\|suprimir totes les contrasenyes\|trobar el programa <em>dvipdfm<\/em>\|visualitzar l'ús del disc\) a l'ordinador\([^[:alnum:]]\)/\1 en l'ordinador\2/g
 #
...
s/\bA l'últim\(a\|\)\([^[:alnum:]]\)/En l'últim\1\2/g
	...
	s/\bLlança't a l'última peça d'or\([^[:alnum:]]\)/Llança't cap a l'última peça d'or\1/g
...
# a l'URL
	s/\bCrea un enllaç a l'URL\([^[:alnum:]]\)/Crea un enllaç amb l'URL\1/g
...
# a la base
	...
	s/\bper a importar-lo a la base de dades\([^[:alnum:]]\)/per a importar-lo cap a la base de dades\1/g
...
# a la capçalera
s/\b\(aparegui\|clic\|desada\|emmagatzemar\|figuri\|mida de la imatge perquè s'adapti\|pestanya d'informació o\|s'especifica\|trobat cap informació\|visualitzarà\) a la capçalera\([^[:alnum:]]\)/\1 en la capçalera\2/g
 #
...
s/\bA la carpeta\([^[:alnum:]]\)/En la carpeta\1/g
	...
	s/\b\(Copia els correus enviats\|copiar els correus enviats\|copiar l'esquema de color\|copieu-lo\|copieu-ne un\|desarà informació del cronometratge\|desaran\|escriure un missatge\) a la carpeta\([^[:alnum:]]\)/\1 a dins de la carpeta\2/g
		s/\bEstabliu aquest camí cap a la carpeta que conté\([^[:alnum:]]\)/Establiu aquest camí a la carpeta que conté\1/g
	...
	s/\bmoure el correu des de la carpeta %1 a la carpeta\([^[:alnum:]]\)/moure el correu des de la carpeta %1 cap a la carpeta\1/g
	s/\b\(Mou el missatge\|Mou els fitxers\|Mou els missatges amb virus detectats\|Mou tots els missatges\|moure'ls\|moure els correus\|moveu un fitxer\) a la carpeta\([^[:alnum:]]\)/\1 cap a la carpeta\2/g
	s/\bmoure la carpeta %1 de la carpeta %2 a la carpeta\([^[:alnum:]]\)/moure la carpeta %1 des de la carpeta %2 cap a la carpeta\1/g
	s/\bmovent %1 missatges antics de la carpeta %2 a la carpeta\([^[:alnum:]]\)/movent %1 missatges antics des de la carpeta %2 cap a la carpeta\1/g
	s/\bmovent un missatge antic de la carpeta %2 a la carpeta\([^[:alnum:]]\)/movent un missatge antic des de la carpeta %2 cap a la carpeta\1/g
	s/\bObre un terminal, a la carpeta actual\([^[:alnum:]]\)/Obre un terminal en la carpeta actual\1/g
	s/\bper a apuntar a la carpeta\([^[:alnum:]]\)/per a que apunti cap a la carpeta\1/g
	s/\bSelecciona-ho tot a la &carpeta\([^[:alnum:]]\)/Selecciona-ho tot en la \&carpeta\1/g
	s/\btrasllat dels missatges antics de la carpeta %1 a la carpeta\([^[:alnum:]]\)/trasllat dels missatges antics des de la carpeta %1 cap a la carpeta\1/g
	s/\btrasllat dels missatges de la carpeta %1 a la carpeta\([^[:alnum:]]\)/trasllat dels missatges des de la carpeta %1 cap a la carpeta\1/g
...
s/\b\(trobat l'adreça de correu\) a la clau\([^[:alnum:]]\)/\1 en la clau\2/g
 #
	s/\benllaç simbòlic a les claus\([^[:alnum:]]\)/enllaç simbòlic cap a les claus\1/g
# a la comunitat
...
# a la col·lecció
	...
	s/\bImporta les dades a la col·lecció\([^[:alnum:]]\)/Importa les dades cap a la col·lecció\1/g
	s/\bImporta un trencaclosques nou des d'un fitxer a la col·lecció\([^[:alnum:]]\)/Importa un trencaclosques nou des d'un fitxer cap a la col·lecció\1/g
...
s/\bA la configuració\([^[:alnum:]]\)/En la configuració\1/g
	...
	s/\bCal definir el camí a la configuració\([^[:alnum:]]\)/Cal establir el camí en la configuració\1/g
	s/\bDisposició a la configuració actual del Plasma\([^[:alnum:]]\)/Disposició des de la configuració actual del Plasma\1/g
	s/\bNo s'ha definit un camí a la configuració\([^[:alnum:]]\)/No s'ha establert un camí cap la configuració\1/g
...
s/\b\(help.start ()»\|calcular expressions matemàtiques\|des d'aquest directori\|Des d'un indicatiu\|Descriu les característiques i els paràmetres referits\|en els scripts i\|executeu\|funciona\|hi ha una altra ordre activa\|imprimeix missatges\|introduïu «base::pa»\|introduïu -per exemple- «print»\|mostra\|mostrar\|mostraran\|mostraran més que aquest nombre total de línies (ordres i sortida)\|Ordres entrades\|però no\|teclejar-los directament\|visualització d'ordres\|visualització dels missatges del sistema\) a la consola\([^[:alnum:]]\)/\1 en la consola\2/g
# a la consulta
...
# a la documentació
	...
	s/\b\(camí «%1»\|enllaç\|opcions importants i\) a la documentació\([^[:alnum:]]\)/\1 cap a la documentació\2/g
	s/\benllaços a opcions\([^[:alnum:]]\)/enllaços cap a opcions\1/g
...
# a la galeria
	s/\b\(Importa un fitxer d'imatge\) a la galeria\([^[:alnum:]]\)/\1 cap a la galeria\2/g
...
# a la guia
	s/\bque conté enllaços a la guia\([^[:alnum:]]\)/que conté enllaços cap a la guia\1/g
...
# a la imatge
    s/\b\(enllaç complet\|es transferiran\) a la imatge\([^[:alnum:]]\)/\1 cap a la imatge\2/g
s/\b\(ajust\|centrat\|conserva la saturació dels colors\|Detecta les estrelles\|determina la mida de les parts copiades\|dibuixa un espectre de l'àudio\|dibuixa un nivell d'àudio\|Emmagatzema la configuració de la provatura suau\|emmagatzemar aquesta paleta\|establir l'escala de magnituds de les estrelles\|Etiquetes\|hi hagi estrelles suficients\|inserit\|marca les estrelles\|més soroll quedarà\|Mostra els objectes\|mostrar el blanc sobreacolorit\|mostrar el negre sobreacolorit\|nombre d'estrelles\|Objectes\|reconstrucció des de Bayer\|se superposin\|seleccionada (o amb la selecció automàtica)\|seleccioneu el punt d'origen\|superposats\|troba les vores de color\|trobada\|trobi\) a la imatge\([^[:alnum:]]\)/\1 en la imatge\2/g
 #
    s/\bcamí a les imatges\([^[:alnum:]]\)/camí cap a les imatges\1/g
...
# a la llibreta
    ...
    s/\bexportar a la llibreta\([^[:alnum:]]\)/exportar cap a la llibreta\1/g
...
s/\bA la llista\([^[:alnum:]]\)/En la llista\1/g
    ...
    s/\bimport\(ar\|eu\)-lo a la llista\([^[:alnum:]]\)/import\1-lo cap a la llista\2/g
    ...
    s/\bmoveu-lo a la llista\([^[:alnum:]]\)/moveu-lo cap a la llista\1/g
...
s/\b\(a causa d'un valor de precisió incorrecte\|cada imatge\|carregar l'adreça\|[Cc]erca el text\|configurar\|detalls\|específic\|especificar el nom del lloc\|Focus\|llistats\|[Oo]bre\|un port\) a la pestanya\([^[:alnum:]]\)/\1 en la pestanya\2/g
...
# a la qual
s/\b\([Aa]justa la velocitat\|mostra la velocitat\|o en la corba\|ubicació\) a la qual\([^[:alnum:]]\)/\1 en la qual\2/g
# a la reacció
 #
...
s/\b\(clau i el nom\|com botons\|del sistema\|establir\|ID de la clau\|literal>\|títol de l'element\) a la secció\([^[:alnum:]]\)/\1 en la secció\2/g
# a la segona
...
s/\b\(1 element\|1 elements\|[Cc]lic\|com un camp\|falten\|[Ii]nclou\|línia\|[Mm]ostra\|[Pp]rem\|previsualització i\|propietat donada d'un element\|punts\|veure la durada de cada esdeveniment\) a la taula\([^[:alnum:]]\)/\1 en la taula\2/g
...
# al fòrum
s/\b\(debatre-ho\|feu preguntes\) al fòrum\([^[:alnum:]]\)/\1 en el fòrum\2/g
# al giny
...
# al disc
s/\b\(canviï\|dades\|desa[rt]\|desaran\|dispositiu\|emmagatzemats\|emmagatzemen\|Error durant l'escriptura\|escenes\|escriptura\|espai\|imatges\|memòria cau\) al disc\([^[:alnum:]]\)/\1 en el disc\2/g
# al dispositiu
...
# al paquet
s/\b\(troba\) al paquet\([^[:alnum:]]\)/\1 en el paquet\2/g
# al patró
s/\b\(Error\) al patró\([^[:alnum:]]\)/\1 en el patró\2/g
# al plafó
s/\bAl plafó\([^[:alnum:]]\)/En el plafó\1/g
s/\b\([Aa]mplada\|apareixerà\|aplicacions i\|baixats\|barra d'eines\|cares<\/u>\|carpeta\|carregar perfils de configuració\|clic\|d'ajuda\|duplicades\|elements\|emergents\|està buit\|executant\|executant-se\|existents\|gestor de fitxers\|icona\|mostren\|Oculta els elements nous\|posició<\/b>\|ressalteu\|transparència\|veurà\) al plafó\([^[:alnum:]]\)/\1 en el plafó\2/g
...
s/\b\(certificat\|copia\|dades útils\|dades vàlides\|de la imatge\|ha actualment\|ha dades\|ha informació\|hi ha\|hi ha cap dada vàlida de fotograma clau\|pantalla\|Permet copiar la imatge\|posa'l\|si n'hi ha,\|[Ss]ubstitueix\|text\) al porta-retalls\([^[:alnum:]]\)/\1 en el porta-retalls\2/g
# al primer
...
s/\b\([Mm]ostrar\|selecciona[rt]\|seleccionada\) al quadre\([^[:alnum:]]\)/\1 en el quadre\2/g
...
s/\b\(cursor\|fitxer\|imatge\|[Mm]ostra el fitxer\|[Mm]ostrar els vídeos\|mostrarà\|[Oo]bre\|rebudes\|s'obriran\|utilitzarà\|veu\) al vis\(or\|ualitzador\)\([^[:alnum:]]\)/\1 en el visualitzador\3/g
# al vostre
...
s/\b\(Mostra efectes sofisticats\) al xat\([^[:alnum:]]\)/\1 en el xat\2/g
# #
# # # # # # # # # # # # # #
#
# a un
