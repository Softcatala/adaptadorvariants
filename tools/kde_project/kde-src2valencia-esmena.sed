...
#
# anàlisi sintàctica
s/\banàlisi d'%2 fitxer\([^[:alnum:]]\)/anàlisi sintàctica d'%2 fitxer\1/g
s/\banàlisi de %2 fitxers\([^[:alnum:]]\)/anàlisi sintàctica de %2 fitxers\1/g
s/\banàlisi del fitxer\([^[:alnum:]]\)/anàlisi sintàctica del fitxer\1/g
 # Errors
s/\banàlisi les \(condicions\|dades\|metadades\|opcions\)\([^[:alnum:]]\)/anàlisi de les \1\2/g
s/\banàlisi la \(col·lecció\|descripció\|font\|informació\|plantilla\|resposta\|supressió\)\([^[:alnum:]]\)/anàlisi de la \1\2/g
s/\banàlisi els fitxers\([^[:alnum:]]\)/anàlisi sintàctica dels fitxers\1/g
s/\banàlisi sintàctica del fitxer d'aparença\([^[:alnum:]]\)/anàlisi del fitxer d'aparença\1/g
s/\banàlisi sintàctica del fitxer d'àudio\([^[:alnum:]]\)/anàlisi del fitxer d'àudio\1/g
s/\banàlisi sintàctica del fitxer de base de dades\([^[:alnum:]]\)/anàlisi del fitxer de base de dades\1/g
s/\banàlisi sintàctica del fitxer del projecte\([^[:alnum:]]\)/anàlisi del fitxer de projecte\1/g
s/\banàlisi sintàctica del fitxer ODS\([^[:alnum:]]\)/anàlisi del fitxer ODS\1/g
s/\banàlisi sintàctica del fitxer en XML\([^[:alnum:]]\)/anàlisi del fitxer en XML\1/g
s/\banàlisi sintàctica XML\([^[:alnum:]]\)/anàlisi de l'XML\1/g
...
# kdnssd/kdnssd6_qt.po
37,/^msgstr / s/\"Servidor\"/\"Amfitrió\"/g
# kget/kget.po
3304,/^msgstr / s/\"Màquina\"/\"Amfitrió\"/g
# kio/kio5.po
# kio/kio6.po
...
# kmail-account-wizard/accountwizard.po
69,/^msgstr / s/\"Servidor:\"/\"Amfitrió:\"/g
# kmuddy/kmuddy.po
2251,/^msgstr / s/\"&Màquina:\"/\"A\&mfitrió:\"/g
# kommit/kommit.po
...
# ksirk/ksirk.po
1187,/^msgstr / s/\"Màquina:\"/\"Amfitrió:\"/g
...
s/\"Màquina VPN\"/\"Amfitrió VPN\"/g
s/\"No s'ha trobat el servidor remot\"/\"No s'ha trobat l'amfitrió\"/g
s/\"nom de la màquina\"/\"nom de l'amfitrió\"/g
s/\"Ordinadors\"/\"Amfitrions\"/g
s/@\*\.màquina\([^[:alnum:]]\)/@*.amfitrió\1/g
s/<br><b>Màquina remota:<\/b> %1/<br><b>Amfitrió remot:<\/b> %1/g
s/«màquina:port»/«amfitrió:port»/g
  s/\bsintaxi és «màquina» o\([^[:alnum:]]\)/sintaxi és «amfitrió» o\1/g
...
s/\bdispositiu]@host[:port]/dispositiu]@amfitrió[:port]/g
...
s/\bClau desconeguda de màquina SSH\([^[:alnum:]]\)/Clau desconeguda de l'amfitrió SSH\1/g
s/\bcol·lecció remota des de l'ordinador\([^[:alnum:]]\)/col·lecció remota des de l'amfitrió\1/g
s/\bcomunicar-se amb la màquina remota\([^[:alnum:]]\)/comunicar-se amb l'amfitrió remot\1/g
s/\bConfigura el nom del servidor i el port\([^[:alnum:]]\)/Configura el nom i el port de l'amfitrió\1/g
s/\bconfiguració de màquina i inici de sessió\([^[:alnum:]]\)/configuració d'amfitrió i inici de sessió\1/g
s/\bconfiguració personalitzada per al servidor\([^[:alnum:]]\)/configuració personalitzada per a l'amfitrió\1/g
s/\bconnecta amb el SERVIDOR\([^[:alnum:]]\)/connecta amb l'AMFITRIÓ\1/g
s/\bConnecta amb la màquina remota a través\([^[:alnum:]]\)/Connecta amb l'amfitrió remot a través\1/g
...
s/\bconnectava amb el servidor nadiu\([^[:alnum:]]\)/connectava amb l'amfitrió nadiu\1/g
...
s/\bEl nom del servidor especificat al certificat no és únic\([^[:alnum:]]\)/El nom de l'amfitrió especificat al certificat no és únic\1/g
s/\bEl servidor %1 ja es troba en la llista\([^[:alnum:]]\)/L'amfitrió %1 ja es troba a la llista\1/g
s/\bEl servidor ja s'ha verificat\([^[:alnum:]]\)/L'amfitrió ja s'ha verificat\1/g
s/\bEl servidor natiu s'ha desconnectat inesperadament\([^[:alnum:]]\)/L'amfitrió natiu s'ha desconnectat inesperadament\1/g
...
s/\bError per a la màquina %1: %2\([^[:alnum:]]\)/Error per a l'amfitrió %1: %2\1/g
...
s/\bés la vostra màquina oculta\([^[:alnum:]]\)/és el vostre amfitrió ocult\1/g
s/\bestà usant la màquina\([^[:alnum:]]\)/està usant l'amfitrió\1/g
...
s/\betiquetes d'aplicació del servidor\([^[:alnum:]]\)/etiquetes de l'aplicació pare\1/g
...
s/\bFes aleatòries les màquines remotes\([^[:alnum:]]\)/Fes aleatoris els amfitrions remots\1/g
s/\bfixades per al nom del servidor\([^[:alnum:]]\)/fixades per al nom de l'amfitrió\1/g
...
s/\bS'ha produït un error de la xarxa amb la màquina %1\([^[:alnum:]]\)/S'ha produït un error de la xarxa amb l'amfitrió %1\1/g
...
s/\binstal·lat el servidor de la Integració\([^[:alnum:]]\)/instal·lat l'amfitrió de la Integració\1/g
  s/\bServidor de la integració\([^[:alnum:]]\)/Amfitrió de la integració\1/g
s/\bintroduir el nom de la màquina que fa de servidor\([^[:alnum:]]\)/introduir el nom de l'amfitrió que fa de servidor\1/g
s/\bIntroduïu aquí la màquina de la xarxa\([^[:alnum:]]\)/Introduïu aquí l'amfitrió de la xarxa\1/g
...
s/\bLa sintaxi és màquina:port\([^[:alnum:]]\)/La sintaxi és amfitrió:port\1/g
...
s/\bMàquina de connexió de xarxa\([^[:alnum:]]\)/Amfitrió de connexió a la xarxa\1/g
s/\bMàquina primària per a les sol·licituds LDAP\([^[:alnum:]]\)/Amfitrió primari per a les sol·licituds LDAP\1/g
s/\bMQTTClient amb aquesta màquina\([^[:alnum:]]\)/MQTTClient amb aquest amfitrió\1/g
s/\bmúltiples màquines per a la redundància\([^[:alnum:]]\)/múltiples amfitrions per a la redundància\1/g
s/\bnativament per la màquina actual\([^[:alnum:]]\)/nativament per l'amfitrió actual\1/g
s/\bno coincideix amb el nom del servidor\([^[:alnum:]]\)/no coincideix amb el nom de l'amfitrió\1/g
s/\bno es pot accedir a la màquina\([^[:alnum:]]\)/no es pot accedir a l'amfitrió\1/g
s/\bNo podeu especificar un servidor amb aquest protocol\([^[:alnum:]]\)/No podeu especificar un amfitrió amb aquest protocol\1/g
...
s/\bNo s'ha trobat el nom del servidor remot (nom de servidor no vàlid)/No s'ha trobat el nom de l'amfitrió remot (nom no vàlid de l'amfitrió)/g
s/\bNo s'ha trobat la màquina %1\([^[:alnum:]]\)/No s'ha trobat l'amfitrió %1\1/g
...
s/\bnom d'ordinador, IPv4 o IPv6\([^[:alnum:]]\)/nom d'amfitrió vàlid, IPv4 o IPv6\1/g
...
s/\bnom de màquina i l'adreça de correu\([^[:alnum:]]\)/nom de l'amfitrió i l'adreça de correu\1/g
...
s/\bnom d'ordinador personalitzat\([^[:alnum:]]\)/nom personalitzat de l'amfitrió\1/g
s/\bnom de màquina del servidor\([^[:alnum:]]\)/nom d'amfitrió del servidor\1/g
s/\bNom del servidor DHCP:/Nom de l'amfitrió DHCP:/g
...
s/\bOrdinador amb el qual connectar-se:/Amfitrió amb el qual connectar-se:/g
...
s/\bPermet a l'usuari establir el nom de màquina del sistema\([^[:alnum:]]\)/Permet a l'usuari establir el nom d'amfitrió del sistema\1/g
s/\bperò els servidors remots també poden veure l'adreça IP\([^[:alnum:]]\)/però els amfitrions remots també poden veure l'adreça IP\1/g
...
s/\bS'està connectant amb la màquina\([^[:alnum:]]\)/S'està connectant amb l'amfitrió\1/g
...
s/\bSessió X en una màquina remota\([^[:alnum:]]\)/Sessió X en un amfitrió remot\1/g
s/\bSi la impressora està en una màquina remota\([^[:alnum:]]\)/Si la impressora està en un amfitrió remot\1/g
s/\bsi la màquina i el port\([^[:alnum:]]\)/si la l'amfitrió i el port\1/g
...
s/\bvincular-se en el servidor d'IRC\([^[:alnum:]]\)/vincular-se en el servidor amfitrió d'IRC\1/g
...
s/\bNo s'ha trobat l'amfitrió \(%1\|de la CDDB\|EteSync\)\([^[:alnum:]]\)/No s'ha trobat el servidor \1\2/g
...
911,/^msgstr / s/\bNo s'ha trobat el servidor %1\([^[:alnum:]]\)/No s'ha trobat l'amfitrió %1\1/g
...
s/\b\([Ll]\)a indica\(ció\|tiu\) de desbloqueig\([^[:alnum:]]\)/\1'indicador de desbloqueig\3/g
  s/\b\([Ii]\)ndica\(ció\|tiu\) de desbloqueig\([^[:alnum:]]\)/\1ndicador de desbloqueig\3/g
...
s/\"\([Ii]\)ndicatiu\"/\"\1ndicador\"/g
s/\brespost amb l'indicatiu\([^[:alnum:]]\)/respost amb l'indicador\1/g
...
473,/^msgstr / s/\"Lluminositat:/\"Brillantor:/g
# calligra/calligra.po
...
251,/^msgstr / s/\"Lluminositat\([^[:alnum:]]\)/\"Brillantor\1/g
# kooka/libkookascan.po
...
451,/^msgstr / s/\"Lluminositat:\"/\"Brillantor:\"/g
 # Error
2931,/^msgstr / s/\"Brillantor\"/\"Lluminositat\"/g # calligra/calligra.po
 #
...
s/\bde la lluminositat de les \(no \|no-\|\)vores\([^[:alnum:]]\)/de la brillantor de les \1vores\2/g
...
s/\bFeu-lo tan lluminós\([^[:alnum:]]\)/Feu-lo tan brillant\1/g
s/\bfluctuacions de la lluminositat\([^[:alnum:]]\)/fluctuacions de la brillantor\1/g
...
s/\blluminositat màxima de la pantalla\([^[:alnum:]]\)/brillantor màxima de la pantalla\1/g
s/\blluminositat mitjana màxima\([^[:alnum:]]\)/brillantor mitjana màxima\1/g
s/\bperill de soroll o punts lluminosos\([^[:alnum:]]\)/perill de soroll o punts brillants\1/g
s/\bPermet establir la lluminositat del dispositiu\([^[:alnum:]]\)/Permet establir la brillantor del dispositiu\1/g
s/\bSortida del color més lluminós d'entrada\([^[:alnum:]]\)/Sortida del color més brillant d'entrada\1/g
s/\buna pantalla 3 K lluminosa\([^[:alnum:]]\)/una pantalla 3 K brillant\1/g
...
s/\bvariació de la lluminositat entre fotogrames\([^[:alnum:]]\)/variació de la brillantor entre els fotogrames\1/g
# #
# # # # # # # # # # # # # #
#
# localització
