...
s/\(\"\|[(t]\| \)\(Alt\|Ctrl\|Esc\|Majús\|Meta\|Tab\)\([-+]\)\([0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ]\|F%[123]\|F[123456789]\|F1[012]\)\([.,:)$]\| \)/\1«\2+\4»\5/g
    s/\"«\(Alt\|Ctrl\|Esc\|Majús\|Meta\|Tab\)\([-+]\)\([0123456789ABCDEFGHIJKLMNOPQRSTUVXYZ]\|Alt\|F%[123]\|F[123456789]\|\|F1[012]\|Meta\|Retorn\)»\"/\"\1+\3\"/g
    s/«+», «-», \//+, -, \//g
    s/(Ctrl+\(\.\|+\|\/\|[,-=]\))/(«Ctrl+\1»)/g
...
# 3
s/\(\"\|[(t]\| \)\(Alt\|Ctrl\|Majús\|Meta\)\([-+]\)\(Alt\|Ctrl\|Majús\)\([-+]\)\([0123456789ABCDEFGHIJKLMNOPQRSTUVXYZ]\|arrossega\|deixa anar\|Esc\|F%[123]\|F[123456789]\|F1[012]\|Fletxa amunt\|Fletxa avall\|Fletxa dreta\|Fletxa esquerra\|Retorn\|Tab\)\(\"\|[.,:)$]\| \)/\1«\2+\4+\6»\7/g
...
s/\b\([Aa]\)l \(<[^<]\{1,\}>\|\[\|«\|\)\(BSD\|Debian\|Haiku\|Linux\|macOS\|MacOS\|MeeGo\|Solaris\|SteamOS\|Windows\)\([^[:alnum:]]\)/\1 \2\3\4/g
s/\b\([Dd]\)el \(<[^<]\{1,\}>\|\[\|«\|\)\(BSD\|Debian\|Haiku\|Linux\|macOS\|MacOS\|MeeGo\|Solaris\|SteamOS\|Windows\)\([^[:alnum:]]\)/\1e \2\3\4/g
s/\b\([Ll]\)'\(<[^<]\{1,\}>\|\[\|«\|\)\(Haiku\|SteamOS\)\([^[:alnum:]]\)/\2\3\4/g
    s/\ben el \(<[^<]\{1,\}>\|\[\|«\|\)\(BSD\|Debian\|Haiku\|Linux\|macOS\|MacOS\|MeeGo\|Solaris\|SteamOS\|Windows\)\([^[:alnum:]]\)/a \1\2\3/g
...
#
s/\bEl \(<[^<]\{1,\}>\|\[\|«\|\)\(Debian\|Fedora\|FreeBSD\|Kubuntu\|Mandrake\|Mandriva\|Manjaro\|Mobian\|openSUSE\|RedHat\|SuSE\|Ubuntu\)\([^[:alnum:]]\)/La \1\2\3/g
s/\bel \(<[^<]\{1,\}>\|\[\|«\|\)\(Debian\|Fedora\|FreeBSD\|Kubuntu\|Mandrake\|Mandriva\|Manjaro\|Mobian\|openSUSE\|RedHat\|SuSE\|Ubuntu\)\([^[:alnum:]]\)/la \1\2\3/g
#
...
s/\bnou \(article\|aspecte\|camp\|cercle\|certificat\|compte\|contacte\|contenidor\|contingut\|diccionari\|element\|fitxer\|graf\|menú\|missatge\|nom\|observador\|paràmetre\|polígon\|projecte\|punt\|segment\|símbol\|tipus\|triangle\|usuari\|valor numèric\|valor\|vector\|venciment\)\([^[:alnum:]]\)/\1 nou\2/g
...
s/\bsegüents \(aplicacions\|calculadores\|camins\|cel·les\|connectors\|controladors\|errors i avisos\|errors\|expansions\|fitxers\|fitxers de desament automàtic\|gestos\|nivells\|nombres\|números\|objectes\|opcions\|paquets\|paraules clau\|posicions\|símbols\|tipus\|usuaris\|variables de posició\|variables\)\([^[:alnum:]]\)/\1 següents\2/g
...
s/\b\([Mm]\)o\(guin\|gut\|u\|uen\|u-ho\|uran\|ure\|ure'l\|ure'ls\|ure-ho\|ure-la\|us\|vent\|veu\|veu-l[ao]\) a la \(<[^<]\{1,\}>\|:ref:`\|[&«]\|\[\|\)\([Pp]\)aperera\([^[:alnum:]]\)/\1o\2 cap a dins de la \3paperera\5/g
s/\b\([Mm]\)o\(guin\|gut\|u\|uen\|u-ho\|uran\|ure\|ure'l\|ure'ls\|ure-ho\|ure-la\|us\|vent\|veu\|veu-l[ao]\) \(&tot\|%1\|%1 element\|%1 elements\|%1 fitxer\|%1 fitxers\|%2\|a una ubicació diferent o\|aquest %1 element\|aquest element\|aquesta peça\|aquests %1 elements\|aquesta imatge\|aquesta %1 peça\|aquestes %1 peces\|aquests fitxers\|directament\|el fitxer\|el missatge\|elements\|els elements de la selecció actual\|els elements seleccionats\|els fitxers\|els missatges\|fitxers\|fitxers o carpetes\|l'element\|l'element seleccionat\|la c&onversa\|la conversa\|peces\|tot\|tots els missatges\|tots els missatges de la carpeta <b>%1<\/b>\|un element o elements seleccionats\) a la \(<[^<]\{1,\}>\|:ref:`\|[&«]\|\[\|\)paperera\([^[:alnum:]]\)/\1o\2 \3 cap a dins de la \4paperera\5/g
s/\b\([Mm]\)o\(guin\|gut\|u\|uen\|u-ho\|uran\|ure\|ure'l\|ure'ls\|ure-ho\|ure-la\|us\|vent\|veu\|veu-l[ao]\) els \(elements\|elements de la selecció actual\) a la \(<[^<]\{1,\}>\|:ref:`\|[&«]\|\[\|\)\([Pp]\)aperera\([^[:alnum:]]\)/\1o\2 els \3 cap a dins de la \4\5aperera\6/g
s/\b\([Mm]\)o\(guin\|gut\|u\|uen\|u-ho\|uran\|ure\|ure'l\|ure'ls\|ure-ho\|ure-la\|us\|vent\|veu\|veu-l[ao]\) la \(carpeta\|col·lecció\|imatge\)\( %1\|\)\( cap\|\) a la paperera\([^[:alnum:]]\)/\1o\2 la \3\4\5 cap a dins de la paperera\6/g
...
s/\b\([Ee]x\|[Ii]m\)port\(a\|ació\|ant\|ar\|es\|eu\|i\) \(a\|al\|als\)\([^[:alnum:]]\)/\1port\2 cap \3\4/g
...
s/\b\(Aquesta és la llista dels fitxers\|El nombre de finestres\|els URL\|Fitxer o fitxers\|Quan se seleccionen múltiples torrents\) a obrir\([^[:alnum:]]\)/\1 que s'obriran\2/g
# observar
...
# sincronitzar
s/\b\(Bústies\|en obrir els fitxers\|per a seleccionar les bústies\|Trieu els camps\|Trieu les col·leccions\) a sincronitzar\([^[:alnum:]]\)/\1 que s'han de sincronitzar\2/g
# situar
...
s/\b\([Pp]\)er \(cancel·lar\|canviar\|carregar\|celebrar\|cercar\|certificar\|classificar\|coincidir\|començar\|comparar\|compartir\|complementar\|completar\|comprovar\|comunicar\|conèixer\|configurar\|connectar\|construir\|continuar\|controlar\|convertir\|córrer\|corregir\|cridar\|crides\)\([^[:alnum:]]\)/\1er a \2\3/g
...
# enviar
s/\b\([Pp]\)er \(editar\|eliminar\|emmirallar\|emplenar\|emprar\|emular\|encriptar\|enganxar\|entendre\|esbrinar\|escriure\|establir\|estalviar\|evitar\|examinar\|executar\|explorar\|exportar\|expulsar\|extreure\)\([^[:alnum:]]\)/\1er a \2\3/g
...
s/\b\([Pp]\)er \(radi\|radio\|realitzar\|rebre\|reduir\|reenviar\|reordenar\|reproductors\|reservar\|restaurar\|revisar\|revitalitzar\)\([^[:alnum:]]\)/\1er a \2\3/g
