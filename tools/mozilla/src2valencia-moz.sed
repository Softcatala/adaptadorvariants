...
s/\([^[:alnum:]]\)\(c\|C\)arregui\(n\?[^[:alnum:]]\|$\)/\1\2arregue\3/g
...
#Cas amb s, cal repensar (amb graph?)
s/\([^[:alnum:]]\)\(S'u\|s'u\|U\|u\)tilitzi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2tilitze\3\4/g
s/\([^[:alnum:]]\)\(S'a\|s'a\|a\|a\)ctualitzi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2ctualitze\3\4/g

s/\([^[:alnum:]]\)\(S'i\|s'i\|I\|i\)nicialitzi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2inicialitze\3\4/g
s/\([^[:alnum:]]\)\(S\|s\)incronitzi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2incronitze\3\4/g
...
s/\([^[:alnum:]]\|^\)\(p\|P\)regunti\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2regunte\3\4/g
s/\([^[:alnum:]]\|^\)\(f\|F\)alli\(n\|s\|\)\([^[:alnum:]]\|$\)/\1\2alle\3\4/g
...
# pero abans compte amb la g
# alnum -> graph -> estalvia problemes de &
s/\([[:graph:]]\)gueixi\([^[:alnum:]]\|$\)/\1guisca\2/g
s/\([[:graph:]]\)gueixis\([^[:alnum:]]\|$\)/\1guisques\2/g
s/\([[:graph:]]\)gueixin\([^[:alnum:]]\|$\)/\1guisquen\2/g
s/\([[:graph:]]\)ueixi\([^[:alnum:]]\|$\)/\1uïsca\2/g
s/\([[:graph:]]\)ueixis\([^[:alnum:]]\|$\)/\1uïsques\2/g
s/\([[:graph:]]\)ueixin\([^[:alnum:]]\|$\)/\1uïsquen\2/g
s/\([[:graph:]]\)eixi\([^[:alnum:]]\|$\)/\1isca\2/g
s/\([[:graph:]]\)eixis\([^[:alnum:]]\|$\)/\1isques\2/g
s/\([[:graph:]]\)eixin\([^[:alnum:]]\|$\)/\1isquen\2/g
# pífies again
...
s/\([^[:alnum:]]\|^\)Vermell\([^[:alnum:]]\|$\)/\1Roig\2/g
s/\([^[:alnum:]]\|^\)vermelles\([^[:alnum:]]\|$\)/\1roges\2/g
s/\([^[:alnum:]]\|^\)vermella\([^[:alnum:]]\|$\)/\1roja\2/g
s/\([^[:alnum:]]\|^\)Vermella\([^[:alnum:]]\|$\)/\1Roja\2/g
...
#Treure -> Traure
s/\([^[:alnum:]]\|^\)\(T\|t\)reure\([^[:alnum:]]\|$\)/\1\2raure\3/g
s/\([^[:alnum:]]\|^\)\(T\|t\)reu\([^[:alnum:]]\|$\)/\1\2rau\3/g
s/\([^[:alnum:]]\|^\)\(T\|t\)reient\([^[:alnum:]]\|$\)/\1\2raient\3/g
s/\([[:alnum:]]\|^\)\(T\|t\)reure\([^[:alnum:]]\|$\)/\1\2raure\3/g
s/\([^[:alnum:]]\|^\)\(E\|e\)xtreu\([^[:alnum:]]\|$\)/\1\2xtrau\3/g
s/\([^[:alnum:]]\|^\)\(E\|e\)xtreient\([^[:alnum:]]\|$\)/\1\2xtraient\3/g

#Enganxar -> Apegar
s/\([^[:alnum:]]\|^\)Enganxar\([^[:alnum:]]\|$\)/\1Apegar\2/g
s/\([^[:alnum:]]\|^\)enganxar\([^[:alnum:]]\|$\)/\1apegar\2/g

s/\([^[:alnum:]]\|^\)enganxant\([^[:alnum:]]\|$\)/\1apegant\2/g

s/\([^[:alnum:]]\|^\)Enganxeu\([^[:alnum:]]\|$\)/\1Apegueu\2/g
s/\([^[:alnum:]]\|^\)enganxeu\([^[:alnum:]]\|$\)/\1apegueu\2/g

s/\([^[:alnum:]]\|^\)enganxat\([^[:alnum:]]\|$\)/\1apegat\2/g

s/\([^[:alnum:]]\|^\)enganxar-lo\([^[:alnum:]]\|$\)/\1apegar-lo\2/g

s/\([^[:alnum:]]\|^\)Enganxa\([^[:alnum:]]\|$\)/\1Apega\2/g
s/\([^[:alnum:]]\|^\)enganxa\([^[:alnum:]]\|$\)/\1apega\2/g

s/\([^[:alnum:]]\|^\)Engan&xa\([^[:alnum:]]\|$\)/\1Ape\&ga\2/g
s/\([^[:alnum:]]\|^\)engan&xa\([^[:alnum:]]\|$\)/\1ape\&ga\2/g
...
#s/\([^[:alnum:]]\|^\)&Desa\([^[:alnum:]]\|$\)/\1Al\&ça\2/g
#s/\([^[:alnum:]]\|^\)&desa\([^[:alnum:]]\|$\)/\1al\&ça\2/g
#s/\([^[:alnum:]]\|^\)&desat\([^[:alnum:]]\|$\)/\1al\&çat\2/g
#s/\([^[:alnum:]]\|^\)&desada\([^[:alnum:]]\|$\)/\1al\&çada\2/g
#s/\([^[:alnum:]]\|^\)&desats\([^[:alnum:]]\|$\)/\1al\&çats\2/g
#s/\([^[:alnum:]]\|^\)&desades\([^[:alnum:]]\|$\)/\1al\&çades\2/g
...
s/\([^[:alnum:]]\|^\)de_sa\([^[:alnum:]]\|$\)/\1_guarda\2/g
s/\([^[:alnum:]]\|^\)De&sa\([^[:alnum:]]\|$\)/\1\&Guarda\2/g
s/\([^[:alnum:]]\|^\)de&sa\([^[:alnum:]]\|$\)/\1\&guarda\2/g
s/\([^[:alnum:]]\|^\)Des&a\([^[:alnum:]]\|$\)/\1Guard\&a\2/g
s/\([^[:alnum:]]\|^\)des&a\([^[:alnum:]]\|$\)/\1guard\&a\2/g
s/\([^[:alnum:]]\|^\)&Desa\([^[:alnum:]]\|$\)/\1Guar\&da\2/g
s/\([^[:alnum:]]\|^\)&desa\([^[:alnum:]]\|$\)/\1guar\&da\2/g
s/\([^[:alnum:]]\|^\)&desat\([^[:alnum:]]\|$\)/\1guar\&dat\2/g
s/\([^[:alnum:]]\|^\)&desada\([^[:alnum:]]\|$\)/\1guar\&dada\2/g
s/\([^[:alnum:]]\|^\)&desats\([^[:alnum:]]\|$\)/\1guar\&dats\2/g
s/\([^[:alnum:]]\|^\)&desades\([^[:alnum:]]\|$\)/\1guar\&dades\2/g
...
#Dos més atures
s/\([^[:alnum:]]\|^\)At&ura\([^[:alnum:]]\|$\)/\1\Pa\&ra\2/g
s/\([^[:alnum:]]\|^\)Atu&ra\([^[:alnum:]]\|$\)/\1\Pa\&ra\2/g


#De l'OOo
#s/\([^[:alnum:]]\|^\)De~sa\([^[:alnum:]]\|$\)/\1Al\~ça\2/g
#s/\([^[:alnum:]]\|^\)de~sa\([^[:alnum:]]\|$\)/\1al\~ça\2/g
s/\([^[:alnum:]]\|^\)&Surt\([^[:alnum:]]\|$\)/\1I\&x\2/g
...
#Recuperat aturar -> parar (Toniher: 20110807) -> es pot netejar després però CAL que funcione
s/\([^_&[:alnum:]]\|^\)s'aturar\(à\|an\)\([^[:alnum:]]\|$\)/\1es parar\2\3/g
s/\([^_&[:alnum:]]\|^\)S'aturar\(à\|an\)\([^[:alnum:]]\|$\)/\1Es parar\2\3/g
s/\([^_&[:alnum:]]\|^\)s'aturi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1es pare\2\3/g
s/\([^_&[:alnum:]]\|^\)aturi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1pare\2\3/g
s/\([^_&[:alnum:]]\|^\)atura\(t\|da\|ts\|des\)\([^[:alnum:]]\|$\)/\1para\2\3/g
s/\([^_&[:alnum:]]\|^\)atur\(a\|en\|ar\|eu\|at\|ada\|ats\|ades\|ant\)\([^[:alnum:]]\|$\)/\1par\2\3/g
s/\([^_&[:alnum:]]\|^\)Atur\(a\|en\|ar\|eu\|at\|ada\|ats\|ades\|ant\)\([^[:alnum:]]\|$\)/\1Par\2\3/g
...
# desar -> alçar
	...
	# l'apostrofament.  Si trobem altres construccions amb "desarà" penso que
	# és millor fer-les per inclussió (rmh)
#s/\([^_&[:alnum:]]\|^\)es desar\(à\|an\)\([^[:alnum:]]\|$\)/\1s'alçar\2\3/g
#s/\([^_&[:alnum:]]\|^\)Es desar\(à\|an\)\([^[:alnum:]]\|$\)/\1S'alçar\2\3/g
#s/\([^_&[:alnum:]]\|^\)es desi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1s'alce\2\3/g
#s/\([^_&[:alnum:]]\|^\)desi\(n\|s\|\)\([^[:alnum:]]\|$\)/\1alce\2\3/g
#s/\([^_&[:alnum:]]\|^\)desa\(t\|da\|ts\|des\)\([^[:alnum:]]\|$\)/\1alça\2\3/g
#s/\([^_&[:alnum:]]\|^\)des\(a\|en\|ar\|eu\|at\|ada\|ats\|ades\)\([^[:alnum:]]\|$\)/\1alç\2\3/g
#s/\([^_&[:alnum:]]\|^\)Des\(a\|en\|ar\|eu\|at\|ada\|ats\|ades\)\([^[:alnum:]]\|$\)/\1Alç\2\3/g
...
s/\([^_&[:alnum:]]\|^\)Des\(a\|en\|ar\|eu\|at\|ada\|ats\|ades\)\([^[:alnum:]]\|$\)/\1Guard\2\3/g
s/\([^[:alnum:]]\|^\)desant\([^[:alnum:]]\|$\)/\1guardant\2/g
s/\([^[:alnum:]]\|^\)desament\([^[:alnum:]]\|$\)/\1guardat\2/g
